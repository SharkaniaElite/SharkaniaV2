...
// ══════════════════════════════════════════════════════════
// Sharkania Replayer — Player Seat v3 — Alta visibilidad
// Fondo sólido oscuro, cartas "md", badges nítidos
// ══════════════════════════════════════════════════════════
...
export function PlayerSeat({
  player, lastAction, isActive = false,
  ...
  // ── HUD colores — fondo SÓLIDO siempre ───────────────────
  ...
  return (
    <div style={{
      ...
      {/* ── Cartas en fan — tamaño "md" ── */}
      <div style={{ height: "62px", display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
        {cards && (
          <CardGroup
            cards={cards}
            size="md"
      ...
      <div style={{
        ...
        {isDealer && (
          <div style={{
            ...
            boxShadow: "0 0 12px rgba(251,191,36,0.65), 0 2px 6px rgba(0,0,0,0.7)",
            zIndex: 10,
          }}>D</div>
        )}
        ...
        {position && posCfg && !isDealer && (
          <div style={{
            ...
            whiteSpace: "nowrap",
            boxShadow: `0 0 12px ${posCfg.glow}, 0 2px 6px rgba(0,0,0,0.7)`,
          }}>{position}</div>
        )}
        ...
        {isActive && (
          <span style={{
            ...
            background: "#22d3ee",
            boxShadow: "0 0 8px #22d3ee, 0 0 18px rgba(34,211,238,0.5)",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
          <div style={{
            ...
            border: `1.5px solid ${isHero ? "#22d3ee" : "rgba(255,255,255,0.20)"}`,
            display: "flex", alignItems: "center", justifyContent: "center",
      ...
      {actionCfg && !isFolded && (
        <div style={{
          ...
          whiteSpace: "nowrap",
          boxShadow: `0 0 12px ${actionCfg.color}35, 0 2px 6px rgba(0,0,0,0.7)`,
        }}>
          {actionCfg.label}
      ...
      {currentBet > 0 && !isFolded && (
        <div style={{
          ...
          padding: "2px 8px", borderRadius: "20px",
          background: "#120f00", border: "1.5px solid rgba(251,191,36,0.55)",
          boxShadow: "0 0 12px rgba(251,191,36,0.22), 0 2px 6px rgba(0,0,0,0.7)",
        }}>
